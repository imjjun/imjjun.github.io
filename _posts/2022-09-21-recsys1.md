---
title: "[RecSys] Introduction to Recommend System: Content-based Filtering"
tags: "RecSys"
---
...
```python
!jupyter nbconvert --to markdown "/content/drive/MyDrive/blog1.md"
```

    [NbConvertApp] WARNING | pattern '/content/drive/MyDrive/blog1.md' matched no files
