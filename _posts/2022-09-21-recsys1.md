...
[데이문 4편 Link](https://dacon.io/competitions/official/235946/codeshare/6046?page=1&dtype=random)


여튼 같이 손코딩 및 md 작성해보면서 추천 시스템에 대해서 구체적으로 알아보는 시간 가져볼게요 !

<Strong>1) 추천 시스템의 정의</Strong>
...
<Strong>1. 콘텐츠 기반 필터링(Content based filitering)</Strong>
